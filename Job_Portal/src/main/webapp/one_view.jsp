					...
					<form class="row g-3" action="editJob" method="post">
						...
						<div class="col-12">
							<label for="inputAddress" class="form-label">Title</label> <input
								type="text" class="form-control" id="inputAddress" readonly
								value="<%=job.getTitle()%>" name="title">
						</div>

						<div class="col-md-4">
							<label for="inputCity" class="form-label">City</label> <select disabled
						...
						<div class="col-md-4">
							<label for="inputState" class="form-label">Category</label> <select disabled
						...
						<div class="form-group">
							...
							<textarea required rows="5" name="description" readonly
